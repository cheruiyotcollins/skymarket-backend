...
void getAllUsers_ShouldReturnUserList() {
    ...
    when(userService.getAllUsers(page, size, sort)).thenReturn(expectedResponse);
    ...
    // Assert
    assertEquals(expectedResponse, actualResponse);
    verify(userService, times(1)).getAllUsers(page, size, sort);
}
    ...
    void deleteById_ShouldReturnResponseEntity() {
        ...
        // Act
        ResponseEntity<ResponseDto> actualResponse = (ResponseEntity<ResponseDto>) userController.deleteUserById(userId);
    ...
    void addRole_ShouldReturnResponseEntity() {
        // Arrange
        AddRoleRequestDto addRoleRequestDto = new AddRoleRequestDto("ROLE_ADMIN");
        ResponseDto responseDto = new ResponseDto();
        ResponseEntity<ResponseDto> expectedResponse = new ResponseEntity<>(responseDto, HttpStatus.CREATED);
